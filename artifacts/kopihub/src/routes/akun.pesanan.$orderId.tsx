...
function OrderDetailPage() {
  ...
  const load = useCallback(async () => {
    ...
    const { data: o } = await supabase
      .from("orders")
      .select("id, order_no, status, payment_status, total, subtotal, delivery_fee, customer_name, customer_phone, delivery_address, fulfillment, note, tracking_number, courier_name, created_at, updated_at, shop:coffee_shops(id, name, slug, logo_url, whatsapp, phone)")
      .eq("id", orderId)
