...
const GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { to: "/admin/credentials", label: "Kredensial & API Keys", icon: ShieldCheck },
      { to: "/admin/migrations", label: "Database Migrations", icon: Database },
